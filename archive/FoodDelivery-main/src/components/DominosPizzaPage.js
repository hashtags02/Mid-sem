...
const restaurant = {
  ...
  rating: 4.6,
  ratingCount: 892,
  id: 'dominos-pizza', // Add restaurant ID
  menu: [
    { id: 'margherita-pizza', name: 'Margherita Pizza', price: 299, description: 'Classic tomato sauce with mozzarella cheese.', category: 'Pizza', photo: 'https://res.cloudinary.com/dlurlrbou/image/upload/v1753335236/pizza_eo0k4v.jpg' },
    { id: 'peppy-paneer-pizza', name: 'Peppy Paneer Pizza', price: 399, description: 'Spicy paneer with capsicum and onions.', category: 'Pizza', photo: 'https://res.cloudinary.com/dlurlrbou/image/upload/v1753335211/food1_z8vt3v.jpg' },
    { id: 'farmhouse-pizza', name: 'Farmhouse Pizza', price: 449, description: 'Fresh vegetables with mushrooms and olives.', category: 'Pizza', photo: 'https://res.cloudinary.com/dlurlrbou/image/upload/v1752563696/410b32a87e020b0e8dbe8a2850d8ca29_socitw.jpg' },
    { id: 'mexican-green-wave', name: 'Mexican Green Wave', price: 399, description: 'Mexican herbs with jalapeños and paprika.', category: 'Pizza', photo: 'https://res.cloudinary.com/dlurlrbou/image/upload/v1753335242/samosa_q7pecl.jpg' },
    { id: 'chicken-wings', name: 'Chicken Wings', price: 199, description: 'Crispy chicken wings with hot sauce.', category: 'Sides', photo: 'https://res.cloudinary.com/dlurlrbou/image/upload/v1752252983/859adef90e854238d9b330d0c7d2cf73_get6ol.jpg' },
    { id: 'garlic-bread', name: 'Garlic Bread', price: 99, description: 'Toasted bread with garlic butter and herbs.', category: 'Sides', photo: 'https://res.cloudinary.com/dlurlrbou/image/upload/v1753335197/burger_yrnmbm.jpg' },
    { id: 'chocolate-lava-cake', name: 'Chocolate Lava Cake', price: 149, description: 'Warm chocolate cake with molten center.', category: 'Desserts', photo: 'https://res.cloudinary.com/dlurlrbou/image/upload/v1752252984/684ca1498560c84097bebc3805da551b_mt0neb.jpg' },
    { id: 'coca-cola', name: 'Coca Cola', price: 79, description: 'Refreshing carbonated soft drink.', category: 'Beverages', photo: 'https://res.cloudinary.com/dlurlrbou/image/upload/v1752252980/01a8503fdbc5be552ae436c2aafcd064_sjk2uw.jpg' },
  ],
};
              ...
              <div className="menu-item" key={idx}>
                <div className="menu-item-main">
                  <div className="menu-item-name-desc">
                    ...
                    <button className="add-to-cart-btn" onClick={() => addToCart({ ...item, restaurantId: restaurant.id })}>
                      Add to Cart
                    </button>
                  </div>
